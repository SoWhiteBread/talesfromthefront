...
function pictureChange(event) {
  ...
  switch(id) {
     case "gang-list-cawdor":
        $(".gangpicture").attr("src", "/main/imgs/cawdor.png");
        break;
      case "gang-list-delaque":
        $(".gangpicture").attr("src", "/main/imgs/delaque.png");
        break;
      case "gang-list-escher":
        $(".gangpicture").attr("src", "/main/imgs/escher.png");
        break;
      case "gang-list-goliath":
        $(".gangpicture").attr("src", "/main/imgs/goliath.png");
        break;
      case "gang-list-vansaar":
        $(".gangpicture").attr("src", "/main/imgs/vansaar.png");
        break;
}};
